...
def ReFeR(instance):
    ...
    while True:
        ...
        try:
            ...
            instance['G_eval'] = all_responses_1
            instance["G_Eval_input_tokens"] = _response.usage.prompt_tokens
            instance["G_Eval_output_tokens"] = _response.usage.completion_tokens
...
if __name__ == '__main__':
    ...
    argparser.add_argument('--prompt_peer', type=str,  default='../prompts/TopicalChat/geval/AC_prompt_coh.txt')
    ...
    argparser.add_argument('--max_len', type=int, default=5)
